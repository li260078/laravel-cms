                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{route('admin.category.update',$category)}}">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" value="{{$category['icon']}}" name="icon" class="form-control " aria-label="Amount (to the nearest dollar)">
                                <div class="input-group-append">
                                    <span class="input-group-text" onclick="eidt()" style="cursor: pointer">选择图标</span>
                                </div>
                            </div>
