                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col ml--2">
                                                            ...
                                                            <h4 class="card-title mb-1 name">
                                                                <a href="{{route('home.article.show',$zan->belongsModel)}}">{{$zan->belongsModel->title}}</a>
                                                            </h4>

                                                            <p class="card-text small mb-1">
                                                                <a href="{{route('member.user.show',$zan->belongsModel->user)}}" class="text-secondary mr-2">
                                                                    <i class="fa fa-user-circle"
                                                                       aria-hidden="true"></i>{{$zan->belongsModel->user->name}}
                                                                </a>

                                                                <i class="fa fa-clock-o"
                                                                   aria-hidden="true"></i>{{$zan->belongsModel->created_at->diffForHumans()}}

                                                                <a href="" class="text-secondary ml-2">
                                                                    <i class="fa fa-folder-o"
                                                                       aria-hidden="true"></i>{{$zan->belongsModel->category->title}}
                                                                </a>
                                                            </p>
                                                        ...
                                                        <div class="col-auto">
                                                            ...
                                                            <!-- Dropdown -->
                                                            <div class="dropdown">
                                                                <a href="{{route('home.zan.make',['type'=>'article','id'=>$zan->belongsModel->id])}}" >
                                                                    取消点赞
                                                                </a>
